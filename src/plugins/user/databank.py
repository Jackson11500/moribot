service_list = {
    ...
    '图包':{'level':0,'cu':6,'pd':0,'ti':0,'th':0},
...
red_paper = {
    '小包':{'cu':20,'pd':20,'ti':1,'th':0},
    '中包':{'cu':40,'pd':40,'ti':5,'th':0},
    '大包':{'cu':75,'pd':75,'ti':10,'th':1},
    '基础包':{'cu':50,'pd':50,'ti':0,'th':0},
    '基础大包':{'cu':200,'pd':200,'ti':0,'th':0}
}
